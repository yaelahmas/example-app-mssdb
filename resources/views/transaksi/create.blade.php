                    ...
                    <div class="card-body">
                        <form action="{{ route('transaksi.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_type') is-invalid @enderror" name="tanggal_type" value="{{ old('tanggal_type') }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="t_komoditas_kode" class="form-control @error('t_komoditas_kode') is-invalid @enderror">
                                    ...
                                    <option value="{{ $k->t_komoditas_kode }}">{{ $k->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('produksi') is-invalid @enderror" name="produksi" value="{{ old('produksi') }}">
